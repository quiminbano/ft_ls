...
#    Updated: 2024/06/27 13:34:10 by corellan         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = ft_ls

SRC = $(addprefix mandatory/, ft_ls.c ft_ls_flags.c ft_ls_fill_lst.c \
...
SRC_B = $(addprefix bonus/, ft_ls_bonus.c ft_ls_flags_bonus.c \
